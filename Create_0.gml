...
vel_h = 0;           // Velocidade Horizontal (será controlada pelo input A/D)
vel_v = 0;           // Velocidade Vertical (queda/pulo)

// --- Variáveis de Pulo ---
spd_pulo = 25;        // Velocidade inicial do pulo (força de subida)
chao = true;         // Flag: Se o jogador está no chão (começa no chão)
// pulo_duplo = false;   // Flag: Se o pulo duplo está disponível